...
class OrderPurchaseTypeUsed extends PurchaseType_used
{
	...
	public function onSaveSale(OrderProduct $OrderProduct, &$SaleProduct, $AssignInventory = false)
	{
		...
		/**
		 * These have to be saved before the main save, for some reason Doctrine
		 * will not save them when saving the main $SaleProduct object
		 */
