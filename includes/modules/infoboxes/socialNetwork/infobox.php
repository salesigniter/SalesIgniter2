...
class InfoBoxSocialNetwork extends InfoBoxAbstract {
	...
	public function show(){
		...
		$youtube = (isset($boxWidgetProperties->youtube) && $boxWidgetProperties->youtube!= '')?'<a target="_blank" href="'.$boxWidgetProperties->youtube.'"><img src="'. sysConfig::getDirWsCatalog() .'templates/' . Session::get('tplDir') . '/images/youtubeSocial.png" /></a>'. $boxWidgetProperties->youtubeText:'';
