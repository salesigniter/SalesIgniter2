<?php
class PurchaseTypeTabNew_tab_general
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		$TabsObj->addTabHeader('purchaseTypeNewSettingsTabGeneral', array('text' => $this->getHeading()))
			->addTabPage('purchaseTypeNewSettingsTabGeneral', array('text' => $inputTable));
	}
}
