<?php
class PurchaseTypeTabUsed_tab_general
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		$TabsObj->addTabHeader('purchaseTypeUsedSettingsTabGeneral', array('text' => $this->getHeading()))
			->addTabPage('purchaseTypeUsedSettingsTabGeneral', array('text' => $inputTable));
	}
}
