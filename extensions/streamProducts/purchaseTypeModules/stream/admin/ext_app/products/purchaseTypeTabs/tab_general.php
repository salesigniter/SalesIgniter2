<?php
class PurchaseTypeTabStream_tab_general
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		$TabsObj->addTabHeader('purchaseTypeStreamSettingsTabGeneral', array('text' => $this->getHeading()))
			->addTabPage('purchaseTypeStreamSettingsTabGeneral', array('text' => $inputTable));
	}
}
