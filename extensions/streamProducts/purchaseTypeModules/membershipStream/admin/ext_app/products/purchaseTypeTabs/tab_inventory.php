<?php
class PurchaseTypeTabMembershipStream_tab_inventory
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		if ($PurchaseType->getConfigData('INVENTORY_ENABLED') == 'True'){
			$TabsObj->addTabHeader('purchaseTypeMembershipStreamSettingsTabInventory', array('text' => $this->getHeading()))
				->addTabPage('purchaseTypeMembershipStreamSettingsTabInventory', array('text' => buildNormalInventoryTabs($Product, $PurchaseType)));
		}
	}
}
