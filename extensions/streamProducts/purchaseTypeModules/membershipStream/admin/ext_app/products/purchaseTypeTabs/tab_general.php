<?php
class PurchaseTypeTabMembershipStream_tab_general
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		$TabsObj->addTabHeader('purchaseTypeMembershipStreamSettingsTabGeneral', array('text' => $this->getHeading()))
			->addTabPage('purchaseTypeMembershipStreamSettingsTabGeneral', array('text' => $inputTable));
	}
}
