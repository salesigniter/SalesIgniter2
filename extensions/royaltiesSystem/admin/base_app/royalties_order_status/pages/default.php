...
$saveForm = htmlBase::newElement('form')
		...
		->attr('action', itw_app_link('appExt=royaltiesSystem&action=save', 'royalties_order_status', 'default'))
		->attr('method', 'post');
...
if ($OrdersStatus){
	...
	foreach($OrdersStatus as $sInfo){
		...
		$royaltiesSystemOrderStatus =  Doctrine_Core::getTable('RoyaltiesSystemOrderStatuses')->findOneByOrdersStatusId($id);
...
<div class="ui-widget ui-widget-content ui-corner-all" style="margin-right:5px;margin-left:5px;">
	<div style="margin:5px;"><?php echo $saveForm->draw();?></div>
</div>