...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo sysConfig::getDirWsCatalog();?>extensions/templateManager/catalog/globalFiles/stylesheet.php?import=<?php echo implode(',', $stylesheets);?>&layout_id=<?php echo $templateLayoutId;?>&tplDir=<?php echo sysConfig::get('TEMPLATE_DIRECTORY');?>" />
	...
	<script type="text/javascript" src="<?php echo sysConfig::getDirWsCatalog();?>extensions/templateManager/catalog/globalFiles/javascript.php?import=<?php echo implode(',', $javascriptFiles);?>&layout_id=<?php echo $templateLayoutId;?>&tplDir=<?php echo sysConfig::get('TEMPLATE_DIRECTORY');?>"></script>
</head>
<body>
<noscript>
	<div class="noscript">
