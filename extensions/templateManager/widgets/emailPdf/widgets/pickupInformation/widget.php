...
class TemplateManagerEmailPdfWidgetPickupInformation extends TemplateManagerEmailPdfWidget
{

	public function __construct() {
		global $App;
		$this->init('pickupInformation');
	}
	...
	public function show(TemplateManagerLayoutBuilder $LayoutBuilder) {
		...
		$Address = $Sale->AddressManager->getAddress('pickup');
