...
class TemplateManagerPrintWidgetShippingValue extends TemplateManagerPrintWidget
{

	public function __construct() {
		global $App;
		$this->init('shippingValue');
	}
	...
	public function showLayoutPreview($WidgetSettings){
		...
		$boxTemplate = new Template($templateFile, sysConfig::getDirFsCatalog() . 'extensions/templateManager/widgets/print/templates/');
	...
	public function show(TemplateManagerLayoutBuilder $LayoutBuilder) {
		...
		$Total = $Sale->TotalManager->get('shipping');
		if ($Total){
		...
		$totalValue = $currencies->format($totalValue);
