<?php
	...
	'columns' => array(
		array('colspan' => 2, 'text' => sysLanguage::get('TEXT_WIDGET_CUFON_HEADING_NAME'))
	)
));

$WidgetSettingsTable->addBodyRow(array(
	'columns' => array(
		array('text' => sysLanguage::get('TEXT_WIDGET_CUFON_FONT_FILE')),
		array('text' => $elementFont->draw())
	)
));
$WidgetSettingsTable->addBodyRow(array(
	'columns' => array(
		array('text' => sysLanguage::get('TEXT_WIDGET_CUFON_ELEMENTS')),
