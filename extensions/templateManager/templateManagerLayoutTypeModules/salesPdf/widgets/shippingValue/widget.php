...
class TemplateManagerWidgetShippingValue extends TemplateManagerWidget
{

	public function __construct() {
		global $App;
		$this->init('shippingValue', false, __DIR__);
	}
	...
	public function show(TemplateManagerLayoutBuilder $LayoutBuilder) {
		...
		if ($Sale->TotalManager->has('shipping')){
