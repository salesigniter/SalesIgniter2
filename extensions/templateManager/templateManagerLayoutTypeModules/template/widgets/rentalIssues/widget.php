...
class TemplateManagerWidgetRentalIssues extends TemplateManagerWidget
{

	public function __construct()
	{
		global $App;
		$this->init('rentalIssues', false, __DIR__);
		...
		if (sysConfig::get('ALLOW_RENTALS') == 'true'){
			...
			if ($userAccount->isLoggedIn() === true){
				...
				if ($QProdRented){
					...
					$cart_contents_string .= htmlBase::newElement('button')->setType('submit')
						->setText(sysLanguage::get('BUTTON_OPEN_TICKET'))->draw();
