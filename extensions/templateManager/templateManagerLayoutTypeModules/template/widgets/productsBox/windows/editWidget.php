...
<fieldset>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="scrollerConfig">
		...
		<tr>
			...
			<td>
				<input type="text" name="products_box_query_limit" value="<?php echo $productsBoxQueryLimit;?>" size="3"> 0 for no limit
			</td>
		</tr>
		<tr>
			<td>Reflect Blocks:</td>
			<td>
				<input type="checkbox" name="products_box_block_reflect" value="1"<?php echo ($productsBoxReflect === true ? ' checked=checked' : '');?>>
			</td>
		</tr>
		<tr>
			<td>Block Width:</td>
			<td>
				<input type="text" name="products_box_block_width" value="<?php echo $productsBoxBlockWidth;?>" size="4"> In Pixels
			</td>
		</tr>
		<tr>
			<td>Block Height:</td>
			<td>
				<input type="text" name="products_box_block_height" value="<?php echo $productsBoxBlockHeight;?>" size="4"> In Pixels
			</td>
		</tr>
	</table>
</fieldset>
