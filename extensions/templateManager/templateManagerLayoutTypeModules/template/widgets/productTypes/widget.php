...
class TemplateManagerWidgetProductTypes extends TemplateManagerWidget
{

	public function __construct()
	{
		global $App;
		$this->init('productTypes', false, __DIR__);
	}
	...
	public function show(TemplateManagerLayoutBuilder $LayoutBuilder)
	{
		...
		if (isset($_GET['products_id'])){
			...
			if (method_exists($ProductType, 'TemplateWidgetShow')){
				$htmlText .= $ProductType->TemplateWidgetShow($boxWidgetProperties);
			}
			/*$purchaseBoxes = array();
			   $purchaseTypes = array();
