...
class TemplateManagerWidgetCustomerInformation extends TemplateManagerWidget
{

	public function __construct() {
		global $App;
		$this->init('customerInformation', false, __DIR__);
	}
	...
	public function show(TemplateManagerLayoutBuilder $LayoutBuilder) {
		...
		$Address = $Sale->AddressManager->getAddress('customer');
