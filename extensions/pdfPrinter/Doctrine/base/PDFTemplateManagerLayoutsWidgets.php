 ...
 */
class PDFTemplateManagerLayoutsWidgets extends Doctrine_Record
{
	...
	{
		parent::setUp();
		$this->hasOne('PDFTemplatesInfoboxes', array(
			'local' => 'identifier',
			'foreign' => 'box_code'));

		$this->hasOne('PDFTemplateManagerLayoutsColumns as Column', array(
			'local' => 'column_id',
			'foreign' => 'column_id'));

		$this->hasMany('PDFTemplateManagerLayoutsWidgetsConfiguration as Configuration', array(
			'local' => 'widget_id',
			'foreign' => 'widget_id',
			'cascade' => array('delete')));

		$this->hasMany('PDFTemplateManagerLayoutsWidgetsStyles as Styles', array(
			'local' => 'widget_id',
			'foreign' => 'widget_id',
			'cascade' => array('delete')));
	}
