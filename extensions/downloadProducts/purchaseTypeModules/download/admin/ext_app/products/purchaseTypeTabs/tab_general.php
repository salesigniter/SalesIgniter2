<?php
class PurchaseTypeTabDownload_tab_general
{
	...
	public function addTab(&$TabsObj, Product $Product, $PurchaseType) {
		...
		$TabsObj->addTabHeader('purchaseTypeDownloadSettingsTabGeneral', array('text' => $this->getHeading()))
			->addTabPage('purchaseTypeDownloadSettingsTabGeneral', array('text' => $inputTable));
	}
}
