...
?>
    ...
    <div id="page-2"><?php include(sysConfig::getDirFsCatalog(). 'extensions/imageRot/admin/base_app/banner_items/pages_tabs/tab_description.php');?></div>
    <div id="page-categories"><?php include(sysConfig::getDirFsCatalog() . 'extensions/imageRot/admin/base_app/banner_items/pages_tabs/tab_groups.php');?></div>
<?php
