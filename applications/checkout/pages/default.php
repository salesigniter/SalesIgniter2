...
<div class="ui-widget ui-widget-content ui-corner-all" style="padding:.3em;"><table border="0" width="100%" cellspacing="0" cellpadding="2">
	<tr>
		...
		<td class="main"><div id="agreeMessage"><?php echo tep_draw_checkbox_field('terms', '1', false) . '&nbsp;<a href="' . itw_app_link('appExt=infoPages', 'show_page', 'conditions') . '" onclick="popupWindow(\'' . itw_app_link('appExt=infoPages&dialog=true', 'show_page', 'conditions') . '\',\'800\',\'600\');return false;">' . sysLanguage::get('TEXT_AGREE_TO_TERMS') . '</a>';?></div></td>
		<?php }else{ ?>
