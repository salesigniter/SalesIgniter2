...
$pageContents = htmlBase::newElement('form')
	->setAction(itw_app_link(null, 'index', 'default'))
	->setName('frm')
	->setMethod('post')
	->html($pageContents)
	->draw();
