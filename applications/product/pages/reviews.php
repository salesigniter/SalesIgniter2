                  ...
                  <tr class="infoBoxContents">
                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td valign="top" class="main"><?php echo tep_break_string(tep_output_string_protected($reviews['reviews_text']), 60, '-<br>') . ((strlen($reviews['reviews_text']) >= 100) ? '..' : '') . '<br><br><i>' . sprintf(sysLanguage::get('TEXT_REVIEW_RATING'), tep_image(sysConfig::get('DIR_WS_TEMPLATE_IMAGES') . 'stars_' . $reviews['reviews_rating'] . '.gif', sprintf(sysLanguage::get('TEXT_OF_5_STARS'), $reviews['reviews_rating'])), sprintf(sysLanguage::get('TEXT_OF_5_STARS'), $reviews['reviews_rating'])) . '</i>'; ?></td>
