...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	if (isset($_GET['action']) && ($_GET['action'] == 'success')){
		?>
		<tr>
			<td class="main" align="center"><?php echo tep_image(sysConfig::get('DIR_WS_TEMPLATE_IMAGES') . 'table_background_man_on_board.gif', sysLanguage::get('HEADING_TITLE'), '0', '0', 'align="left"') . sysLanguage::get('TEXT_SUCCESS'); ?></td>
		</tr>
		<?php
								...
								<table border="0" width="100%" cellspacing="0" cellpadding="2">
									...
									<tr>
										...
										<td class="main"><?php
											...
											?></td>
										<td class="main">
											<a href="<?php echo itw_app_link('action=details&issueID=' . $iIssue['issue_id'], 'account', 'rental_issues') ?>"><?=sysLanguage::get('TEXT_DETAILS')?>
										</td>
									</tr>
									<?php } ?>
								</table>
...
if ($_GET['action'] == 'details' && isset($_GET['issueID'])){
	$pageContents = htmlBase::newElement('form')
		->setAction(itw_app_link('action=resolve_ticket', 'account', 'rental_issues'))
		->setName('rental_issues_details')
		->setMethod('post')
		->html($pageContents)
		->draw();
}
