...
CKEDITOR.dialog.add( 'link', function( editor )
{
	...
	{
		var dialog = this.getDialog(),
			partIds = [ 'urlOptions', /*'appOptions', */'anchorOptions', 'emailOptions' ],
					...
					[
						{
							...
							items :
								[
									[ linkLang.toUrl, 'url' ],
									//[ /*linkLang.toApp*/'Application', 'app' ],
								...
								[
									{
										...
										children :
											[
												{
													type : 'html',
													html: '<select class="systemLinkType" name="ck_editor_ses_link" data-input_key="0">' +
