...
$DateFormatShortInput = htmlBase::newElement('input')->setName('date_format_short')
	->val((string)$langData->date_format_short);
$DateFormatLongInput = htmlBase::newElement('input')->setName('date_format_long')
	->val((string)$langData->date_format_long);
$DateTimeFormatInput = htmlBase::newElement('input')->setName('date_time_format')
	->val((string)$langData->date_time_format);
$DefaultCurrencyInput = htmlBase::newElement('input')->setName('default_currency')
	->val((string)$langData->default_currency);
