	...
	<table>
		<tr>
			...
			<td rowspan="5" valign="top" id="dayFilter" class="reportTypeFilter">
				<table width="550px">
					<tr>
						<td style="text-align: center;"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_DATE_FROM');?></u></b>

							<div id="date_from"></div>
							<input type="hidden" name="date_from"></td>
						<td style="text-align: center;">
							<b><u><?php echo sysLanguage::get('TEXT_ENTRY_DATE_TO');?></u></b>

							<div id="date_to"></div>
							<input type="hidden" name="date_to"></td>
					</tr>
				</table>
			</td>
			<td id="monthFilter" class="reportTypeFilter">
				<table>
					<tr>
						<td style="text-align: center;">
							<b><u><?php echo sysLanguage::get('TEXT_ENTRY_MONTH_FROM');?></u></b>

							<div><?php echo $monthFromSelect->draw() . ' ' . $yearFromSelect->draw();?></div>
						</td>
						<td style="text-align: center;"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_MONTH_TO');?></u></b>

							<div><?php echo $monthToSelect->draw() . ' ' . $yearToSelect->draw();?></div>
						</td>
					</tr>
				</table>
			</td>
			<td id="yearFilter" class="reportTypeFilter">
				<table>
					<tr>
						<td style="text-align: center;"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_YEAR_FROM');?></u></b>

							<div><?php echo $yearFromSelect->draw();?></div>
						</td>
						<td style="text-align: center;">
							<b><u><?php echo sysLanguage::get('TEXT_ENTRY_YEAR_TO');?></u></b>

							<div><?php echo $yearToSelect->draw();?></div>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				<input type="checkbox" class="checkAll" tooltip="<?php echo sysLanguage::get('TEXT_INFO_CHECK_ALL_STORES');?>"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_STORES');?></u></b> <?php echo $StoresBoxes->draw();?>
			</td>
		</tr>
		<tr>
			<td>
				<input type="checkbox" class="checkAll" tooltip="<?php echo sysLanguage::get('TEXT_INFO_CHECK_ALL_INCOME');?>"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_INCOME_COLUMNS');?></u></b> <?php echo $IncomeColumnBoxes->draw();?>
			</td>
		</tr>
		<tr>
			<td>
				<input type="checkbox" class="checkAll" tooltip="<?php echo sysLanguage::get('TEXT_INFO_CHECK_ALL_EXPENSE');?>"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_EXPENSE_COLUMNS');?></u></b> <?php echo $ExpenseColumnBoxes->draw();?>
			</td>
		</tr>
		<tr>
			<td>
				<input type="checkbox" class="checkAll" tooltip="<?php echo sysLanguage::get('TEXT_INFO_CHECK_ALL_PAYMENT');?>"><b><u><?php echo sysLanguage::get('TEXT_ENTRY_PAYMENT_MODULES');?></u></b> <?php echo $PaymentModules->draw();?>
			</td>
		</tr>
		<tr>
			<td><?php
