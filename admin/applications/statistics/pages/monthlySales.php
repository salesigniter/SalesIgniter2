...
<div style="text-align:right;">
	<form name="status_select" action="<?php echo itw_app_link();?>" method="GET"><?php
...
$headerCols = array(
	array(
		...
		'valign' => 'bottom',
		'width'  => '45',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_MONTH'))
	),
	array(
		'align'  => 'left',
		'valign' => 'bottom',
		'width'  => '35',
		'text'   => mirror_out($col2Text)
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_INCOME'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_SALES'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_RENTAL_MEMBERSHIPS'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_NONTAXED'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_TAXED'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_TAX_COLL'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_SHIPHNDL'))
	),
	array(
		'align'  => 'right',
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_SHIP_TAX'))
	)
);
...
if ($loworder){
	$headerCols[] = array(
		...
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_LOWORDER'))
	);
}
...
if ($extra_class){
	$headerCols[] = array(
		...
		'valign' => 'bottom',
		'width'  => '70',
		'text'   => mirror_out(sysLanguage::get('TABLE_HEADING_OTHER'))
	);
}
...
if ($Result){
	...
	foreach($Result as $sInfo){
		...
		if ($rows > 1 && $sInfo['row_year'] <> $last_row_year){
			...
			$bodyRowCols = array(
				array(
					'css'  => $cssLeft,
					'text' => mirror_out($col1Text)
				),
				array(
					'css'  => $cssLeft,
					'text' => mirror_out($last_row_year)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_gross)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_sales)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_rentals)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_sales_nontaxed)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_sales_taxed)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_tax_coll)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_shiphndl)
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out(($footer_shipping_tax <= 0) ? 0 : $footer_shipping_tax)
				)
			);
			...
			if ($loworder){
				$bodyRowCols[] = array(
					'css'    => $cssRight,
					'format' => 'currency',
					'text'   => mirror_out($footer_loworder)
				);
			}
		...
		$bodyRowCols = array(
			...
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($gross_sales_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($net_sales_this_row + $zero_rated_net_sales_this_row - $rentals_sales_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($rentals_sales_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($zero_rated_net_sales_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($net_sales_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($sales_tax_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($shiphndl_this_row)
			),
			array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($col9Text)
			)
		);
		...
		if ($loworder){
			$bodyRowCols[] = array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($loworder_this_row)
			);
		}
		...
		if ($extra_class){
			$bodyRowCols[] = array(
				'align'  => 'right',
				'format' => 'currency',
				'text'   => mirror_out($other_this_row)
			);
		}
		...
		if ($rows == $lastRowNum){
			...
			$bodyRowCols = array(
				...
				array(
					'css'  => $cssLeft,
					'text' => mirror_out($sInfo['row_year'])
				),
				array(
					'css'    => $cssRight,
					'format' => 'currency',
	...
	$form->append(htmlBase::newElement('button')->setType('submit')->usePreset('save')
		->setText(sysLanguage::get('TEXT_BUTTON_REPORT_SAVE')));
}
else {
	$reportTable->addBodyRow(array(
		'columns' => array(
			array(
				...
				'text'    => sysLanguage::get('TEXT_NOTHING_FOUND')
			)
		)
	));
}
