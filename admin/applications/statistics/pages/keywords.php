	...
	$tableGrid->addHeaderRow(array(
		'columns' => array(
			array(
				'allowSort' => true,
				'sortKey'   => 'sws_word',
				'text'      => sysLanguage::get('TABLE_HEADING_ORIGINAL_WORDS')
			),
			array(
				'allowSort' => true,
				'sortKey'   => 'sws_replacement',
				'text'      => sysLanguage::get('TABLE_HEADING_REPLACEMENT_WORDS')
			),
		...
		foreach($Result as $wInfo){
			...
			$tableGrid->addBodyRow(array(
				'columns' => array(
					...
					array(
						'align' => 'right',
						'text'  => $editButton->draw() . $deleteButton->draw()
					)
				)
			));
		}
	...
	$tableGrid->addHeaderRow(array(
		'columns' => array(
			array(
				'allowSort' => true,
				'sortKey'   => 'search_text',
				'text'      => sysLanguage::get('TABLE_HEADING_SEARCH_WORDS')
			),
			array(
				'allowSort' => true,
				'sortKey'   => 'search_count',
				'text'      => sysLanguage::get('TABLE_HEADING_SEARCH_COUNT')
			)
		)
	));
