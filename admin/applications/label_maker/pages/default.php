...
?>
<div class="hideForPrint main" style="text-align:right;margin:.5em;"><?php
	echo htmlBase::newElement('button')->setName('genList')->setId('genList')
		->setText(sysLanguage::get('TEXT_BUTTON_GENERATE_LIST'))->draw();
	?></div>
...
<div class="ui-widget ui-widget-content ui-corner-all middleTable" style="margin:.5em;padding:.5em;">
	<table cellpadding="2" cellspacing="0" border="0" id="reservations" width="100%">
		<thead>
		<tr>
			<th class="ui-widget-header" style="text-align:left;border-right:none;">
...
<div class="hideForPrint main" style="text-align:right;margin:.5em;"><?php
	echo htmlBase::newElement('button')->setName('genLabels')->setId('genLabels')
		->setText(sysLanguage::get('TEXT_BUTTON_GENERATE_LABELS'))->draw();
	echo htmlBase::newElement('button')->setName('printPage')->setId('printPage')
		->setText(sysLanguage::get('TEXT_BUTTON_PRINT_PAGE'))->draw();
	?></div>
