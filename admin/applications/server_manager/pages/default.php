...
foreach($Snapshots as $archive){
	if ($archive->isDot() || $archive->isDir()) {
		continue;
	}
...
$tableGrid->addButtons(array(
	htmlBase::newElement('button')->setText('New Snapshot')
		->addClass('snapshotButton') /*->setHref(itw_app_link('action=generateSnapshot', 'server_manager', 'default', 'SSL'))*/,
