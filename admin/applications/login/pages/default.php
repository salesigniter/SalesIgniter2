<form name="login" action="<?php echo itw_app_link('action=processLogin');?>" method="post">
	<div class="ui-widget ui-widget-content ui-corner-all loginBox" style="border-color:#222222;margin-left:auto;margin-right:auto;">
		...
		<div class="ui-widget-body" style="margin:10px;">
			<?php echo sysLanguage::get('ENTRY_LOGIN_EMAIL_ADDRESS'); ?><br>
			<?php echo htmlBase::newElement('input')->setRequired(true)->setName('email_address')->css('width', '100%')->draw(); ?>
			<br><br>
			<?php echo sysLanguage::get('ENTRY_LOGIN_PASSWORD'); ?><br>
			<?php echo htmlBase::newElement('input')->setType('password')->setName('password')->setRequired(true)->css('width', '100%')->draw(); ?><br><br>
