...
<div id="langTab_<?php echo $lID;?>">
	<table cellpadding="3" cellspacing="0" border="0">
		<tr>
			<td class="main"><?php echo sysLanguage::get('TEXT_ENTRY_CATEGORIES_NAME'); ?></td>
			<td class="main"><?php echo tep_draw_input_field('categories_name[' . $lID . ']', $name); ?></td>
		</tr>
		<tr>
			<td class="main" valign="top"><?php echo sysLanguage::get('TEXT_ENTRY_CATEGORIES_DESCRIPTION'); ?></td>
		...
		<tr>
			<td class="main"><?php echo sysLanguage::get('TEXT_ENTRY_CATEGORIES_SEO_URL'); ?></td>
