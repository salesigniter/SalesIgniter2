...
$infoTable->addBodyRow(array(
	'columns' => array(
		array(
			'addCls' => 'main',
			'text'   => sysLanguage::get('TEXT_INFO_FIRSTNAME')
		),
		array(
			'addCls' => 'main',
			'text'   => tep_draw_input_field('admin_firstname', $adminFirstname)
		)
	)
));
...
$infoTable->addBodyRow(array(
	'columns' => array(
		array(
			'addCls' => 'main',
			'text'   => sysLanguage::get('TEXT_INFO_LASTNAME')
		),
		array(
			'addCls' => 'main',
			'text'   => tep_draw_input_field('admin_lastname', $adminLastname)
		)
	)
));
...
$infoTable->addBodyRow(array(
	'columns' => array(
		...
		array(
			'addCls' => 'main',
			'text'   => tep_draw_input_field('admin_email_address', $adminEmailAddress)
		)
	)
));
...
$infoTable->addBodyRow(array(
	'columns' => array(
		...
		array(
			'addCls' => 'main',
			'text'   => tep_draw_password_field('admin_password')
		)
	)
));
...
$infoTable->addBodyRow(array(
	'columns' => array(
		array(
			'addCls' => 'main',
			'text'   => sysLanguage::get('TEXT_INFO_PASSWORD_CONFIRM')
		),
		array(
			'addCls' => 'main',
			'text'   => tep_draw_password_field('admin_password_confirm')
		)
	)
));
?>
