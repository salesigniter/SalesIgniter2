...
$listTable->addHeaderRow(array(
	...
	'columns' => array(
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_CUSTOMER_ID')
		),
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_CUSTOMER_NAME')
		),
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_CUSTOMER_IP_ADDRESS')
		),
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_REDEEM_DATE')
		),
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_TOTAL_CUSTOMER_REDEMPTIONS')
		),
		array(
			'align' => 'left',
			'text'  => sysLanguage::get('TABLE_HEADING_TOTAL_REDEMPTIONS')
		)
	)
));
