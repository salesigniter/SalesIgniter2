					...
					<tr><?php echo '<form name="mail" action="' . itw_app_link('action=send_email_to_user', 'coupons', 'gv_mail') . '" method="post">'; ?>
						<td>
							<table border="0" width="100%" cellpadding="0" cellspacing="2">
								...
								<tr>
									<td class="smallText">
										<b><?php echo sysLanguage::get('TEXT_CUSTOMER'); ?></b><br><?php echo $mail_sent_to; ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
								...
								<tr>
									<td class="smallText">
										<b><?php echo sysLanguage::get('TEXT_FROM'); ?></b><br><?php echo htmlspecialchars(stripslashes($_POST['from'])); ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
								...
								<tr>
									<td class="smallText">
										<b><?php echo sysLanguage::get('TEXT_SUBJECT'); ?></b><br><?php echo htmlspecialchars(stripslashes($_POST['subject'])); ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
								...
								<tr>
									<td class="smallText">
										<b><?php echo sysLanguage::get('TEXT_AMOUNT'); ?></b><br><?php echo nl2br(htmlspecialchars(stripslashes($_POST['amount']))); ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
								...
								<tr>
									<td class="smallText">
										<b><?php echo sysLanguage::get('TEXT_MESSAGE'); ?></b><br><?php echo nl2br(htmlspecialchars(stripslashes($_POST['message']))); ?>
									</td>
								</tr>
								<tr>
									<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
								...
								<tr>
									<td>
										...
										<table border="0" width="100%" cellpadding="0" cellspacing="2">
											<tr>
												<td><?php echo htmlBase::newElement('button')->setType('submit')
													->setName('back_x')->setText('Back')->draw() ?></td>
												<td align="right"><?php echo htmlBase::newElement('button')
													->setHref(itw_app_link(null, 'coupons', 'gv_mail'))
													->setText('Cancel')->draw() . htmlBase::newElement('button')
													->setType('submit')->setText('Send Mail')->draw() ?></td>
											</tr>
										</table>
									</td>
								</tr>
					...
					<tr><?php echo '<form name="mail" action="' . itw_app_link('action=preview', 'coupons', 'gv_mail') . '" method="post">'; ?>
						<td>
							<table border="0" cellpadding="0" cellspacing="2">
								...
								$customers = array();
								$customers[] = array('id'   => '',
													 'text' => sysLanguage::get('TEXT_SELECT_CUSTOMER')
								);
								$customers[] = array('id'   => '***',
													 'text' => sysLanguage::get('TEXT_ALL_CUSTOMERS')
								);
								$customers[] = array('id'   => '**D',
													 'text' => sysLanguage::get('TEXT_NEWSLETTER_CUSTOMERS')
								);
								...
								<tr>
									<td colspan="2" align="right"><?php echo htmlBase::newElement('button')
										->setType('submit')->setText('Send Mail')->draw(); ?></td>
								</tr>
							</table>
						</td>
