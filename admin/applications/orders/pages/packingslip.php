	...
	<tr>
		<td>
			<table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
				<tr>
					<td class="main"><b><?php echo sysLanguage::get('HEADING_SHIPPING_INFORMATION'); ?></b></td>
				</tr>
				<tr>
							...
							<tr class="infoBoxContents">
								<td valign="top">
									<table border="0" width="100%" cellspacing="0" cellpadding="2">
										<tr>
											<td class="main">
												<b><?php echo sysLanguage::get('HEADING_SHIPPING_ADDRESS'); ?></b></td>
										</tr>
										<tr>
											<td class="main"><?php
												echo $Order->getFormattedAddress('delivery');
												?></td>
										</tr>
...
<?php
				...
				?>
				<td width="<?php echo ($Order->hasShippingMethod() === true ? '70%' : '100%'); ?>" valign="top">
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<table border="0" width="100%" cellspacing="0" cellpadding="2">
									...
									if ($Order->hasTaxes() === true){
										...
										<tr>
											<td class="main" colspan="2">
												<b><?php echo sysLanguage::get('HEADING_PRODUCTS'); ?></b></td>
											<td class="smallText" align="right">
												<b><?php echo sysLanguage::get('HEADING_TAX'); ?></b></td>
											<td class="smallText" align="right">
												<b><?php echo sysLanguage::get('HEADING_TOTAL'); ?></b></td>
										</tr>
										<?php
									}
									else {
