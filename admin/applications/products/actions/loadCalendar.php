							...
							foreach($Qbookings as $rbInfo){
								...
								$eventsTable->addBodyRow(array(
									'columns' => array(
										...
										array(
											'addCls' => 'smallText',
											'text'   => tep_date_short($rbInfo['OrdersProducts'][0]['OrdersProductsReservation'][0]['start_date']) . ' - ' . tep_date_short($rbInfo['OrdersProducts'][0]['OrdersProductsReservation'][0]['end_date'])
										),
										array(
											'addCls' => 'smallText',
											'text'   => $bInfo['OrdersProducts'][0]['barcode']
										),
										array(
											'addCls' => 'smallText',
											'text'   => '<a href="' . itw_app_link('orders_id=' . $rbInfo['orders_id'], 'orders', 'details') . '" style="text-decoration:underline;">View</a>'
										)
									)
								));
							...
							foreach($QrentedProducts as $pInfo){
								...
								$eventsTable->addBodyRow(array(
									'columns' => array(
										array(
											'addCls' => 'smallText',
											'text'   => $Qcustomer[0]['customers_firstname'] . ' ' . $Qcustomer[0]['customers_lastname']
										),
										array(
											'addCls' => 'smallText',
											'text'   => '1'
										...
										array(
											'addCls' => 'smallText',
											'text'   => tep_date_short($pInfo['shipment_date'])
										),
										array(
											'addCls' => 'smallText',
											'text'   => $bInfo['barcode']
