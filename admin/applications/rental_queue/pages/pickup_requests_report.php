...
if ($pickupr){
	foreach($pickupr as $pickup){
		...
		if (isset($pickup['Customers']['customers_delivery_address_id'])){
			$deliveryAdress = $pickup['Customers']['customers_delivery_address_id'];
		}
		else {
			$deliveryAdress = $pickup['Customers']['customers_default_address_id'];
		}
		...
		$gridBodyColumns = array(
			...
			array('text' => $pickup['Customers']['customers_firstname'] . ' ' . $pickup['Customers']['customers_lastname']),
