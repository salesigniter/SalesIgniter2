  ...
  function create_coupon_code($salt="secret", $length=SECURITY_CODE_LENGTH) {
    ...
    while ($good_result == 0) {
      ...
      $Check = Doctrine_Manager::getInstance()
		...
		->fetchAssoc("select coupon_code from " . TABLE_COUPONS . " where coupon_code = '" . $id1 . "'");    
      if (sizeof($Check) == 0) $good_result = 1;
    }
    return $id1;
  }
////
...
// Output a day/month/year dropdown selector
  function tep_draw_date_selector($prefix, $date='') {
    $month_array = array();
    $month_array[1] =sysLanguage::get('_JANUARY');
    $month_array[2] =sysLanguage::get('_FEBRUARY');
    $month_array[3] =sysLanguage::get('_MARCH');
    $month_array[4] =sysLanguage::get('_APRIL');
    $month_array[5] =sysLanguage::get('_MAY');
    $month_array[6] =sysLanguage::get('_JUNE');
    $month_array[7] =sysLanguage::get('_JULY');
    $month_array[8] =sysLanguage::get('_AUGUST');
    $month_array[9] =sysLanguage::get('_SEPTEMBER');
    $month_array[10] =sysLanguage::get('_OCTOBER');
    $month_array[11] =sysLanguage::get('_NOVEMBER');
    $month_array[12] =sysLanguage::get('_DECEMBER');
