...
class Orders extends Doctrine_Record
{
	...
	public function preInsert($event) {
		$this->date_purchased = date(DATE_TIMESTAMP);
	}

	public function preUpdate($event) {
		$this->last_modified = date(DATE_TIMESTAMP);
	}
	...
	public function setTableDefinition() {
		...
		$this->hasColumn('last_modified', 'timestamp');
		$this->hasColumn('date_purchased', 'timestamp');
		$this->hasColumn('orders_date_finished', 'timestamp');
