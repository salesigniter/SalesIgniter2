(function ($) {
	...
	var labelsToLoad = [
		jsConfig.get('DIR_WS_CATALOG') + 'ext/dymo_label_framework.js',
		jsConfig.get('DIR_WS_CATALOG') + 'ext/labelPrinterMethods/DymoPrinting.js',
		jsConfig.get('DIR_WS_CATALOG') + 'ext/labelPrinterMethods/PdfPrinting.js',
		jsConfig.get('DIR_WS_CATALOG') + 'ext/labelPrinterMethods/SpreadsheetPrinting.js'
	];
